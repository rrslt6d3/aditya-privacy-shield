...
function AppContent() {
  ...
  const generateCompliancePDF = () => {
    ...
    doc.setFontSize(11);
    doc.text("This document certifies data processed entirely offline using", 20, 80);
    doc.text("military-grade local encryption. All PII was redacted per", 20, 87);
    doc.text("GDPR and HIPAA Safe Harbor standards.", 20, 94);
    doc.setFontSize(12);
    doc.setTextColor(0, 0, 0);
    doc.text("Cryptographic Hash (SHA-256):", 20, 115);
    doc.setFontSize(9);
    doc.setTextColor(16, 185, 129);
    doc.text(auditHash, 20, 122);
    ...
    <div className="enterprise-layout">
      ...
      <main className="main-workspace">
        ...
        <div className="panel intro-panel">
          ...
          <p className="panel-subtitle">Military-grade local redaction · Zero data leaves your device</p>
        </div>
        ...
        <div
          ...
          style={{ opacity: secureText ? 1 : 0.4, pointerEvents: secureText ? 'all' : 'none' }}
        >
          ...
          <div className="action-row" style={{ visibility: secureText ? 'visible' : 'hidden' }}>
            ...
            <div className="button-group">
              ...
              <button className="secondary-button pdf-button" onClick={generateCompliancePDF}>
                Download PDF Cert
              </button>
            </div>
          </div>
