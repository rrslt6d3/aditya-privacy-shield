...
function AppContent() {
  ...
  const generateCompliancePDF = () => {
    ...
    doc.text("System: Aditya Labs Privacy Shield Pro", 20, 52);
    ...
    doc.save(`AdityaLabs_Compliance_${new Date().getTime()}.pdf`);
  };
        ...
        {secureText && !isScanning && (
          <div className="panel result fade-in">
            ...
            <div style={{ display: 'flex', gap: '15px', marginTop: '1rem' }}>
              ...
              <button onClick={generateCompliancePDF} className="download-button">
